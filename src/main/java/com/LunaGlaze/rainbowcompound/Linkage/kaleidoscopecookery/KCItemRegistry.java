...
public class KCItemRegistry {
    ...
    public static final DeferredHolder<Item, Item> obsidianiteKitchenKnife = ITEMS.register("obsidianite_kitchen_knife", RainbowKitchenKnife::new);
    ...
    public static final DeferredHolder<Item, Item> shadowSteelKitchenKnife = ITEMS.register("shadow_steel_kitchen_knife", RainbowKitchenKnife::new);
}
